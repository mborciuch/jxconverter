...
public class JsonEqualNodeListWithAttributesPrinter implements Printer {
    ...
    public String prepareElement(AbstractNode abstractNode) {
        ...
        stringBuilder.append(EMPTY_SPACE.repeat(Xml2JsonConverter.getCurrentIndentation()));
        stringBuilder.append(JSON_QUOTE).append(ELEMENT_SIGN).append(nodelist.getNodeName()).append(JSON_QUOTE).append(EMPTY_SPACE).append(JSON_COLON).append(EMPTY_SPACE);
