package converters.json2xml.components;

import com.fasterxml.jackson.databind.ObjectMapper;
import converters.factories.NodeFactory;
import converters.factories.XmlPrinterFactory;
import converters.json2xml.XmlConverter;
...
public class XmlElementTest {
    ...
    public static void prepareConverter(){
        ...
        xmlConverter = new XmlConverter(nodeFactory, objectMapper);
    }
